...
export default function Login() {
  ...
  setError(msg || 'Please verify your email first')

  // OPTIONAL: redirect after user sees message
  setTimeout(() => {
  ...
  const handleVerifyOTP = async () => {
    ...
    setLoading(true)
    try {
      const res = await api.post('/auth/verify-login-otp', { email: form.email, otp: otpString })
        ...
        <div className="w-full md:w-[45%] bg-white px-6 md:px-10 py-10 md:py-12 flex flex-col justify-center">
          ...
          {step === 'credentials' ? (
            <>
              ...
              <p className="text-sm text-gray-400 italic mb-7">Sign in to your DevTrack account</p>
            ...
            <>
              ...
              <p className="text-sm text-gray-400 italic mb-7">One last step to sign in securely</p>
              <OTPInput
                otp={otp}
                setOtp={setOtp}
